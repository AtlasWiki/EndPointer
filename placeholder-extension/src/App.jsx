    ...
    <div className="w-full mx-0">
      ...
      <div className="flex flex-col justify-left gap-10 mx-0">
        <div className="flex flex-col gap-1">
          <h2 className="text-xl">Endpoint parsing</h2>
          <div className="text-md flex gap-2">
              ...
              <button className="font-semibold"><span className="text-violet-500">URLs</span> (57)</button>
          </div>
        </div>

        <div className="flex flex-col gap-1">
          <h2 className="text-xl">JS Downloader</h2>
          <div className="text-md flex gap-2">
               <button>
                  <div className="flex">
                      <div className="flex items-center">
              ...
              <button className="font-semibold"><span className="text-violet-500">JS-FILES</span> (16)</button>
          </div>
        </div>
      </div>
